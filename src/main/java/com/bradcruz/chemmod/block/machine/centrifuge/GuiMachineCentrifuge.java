...
public class GuiMachineCentrifuge extends GuiContainer {
    ...
    private static final ResourceLocation TEXTURES = new ResourceLocation(Main.MODID + ":textures/gui/machine_centrifuge.png");
    private final InventoryPlayer player;
    private final TileEntityMachineCentrifuge tileEntity;

    public GuiMachineCentrifuge(InventoryPlayer player, TileEntityMachineCentrifuge tileEntity) {
        super(new ContainerMachineCentrifuge(player, tileEntity));
        this.player = player;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if(TileEntityMachineCentrifuge.isActive(tileEntity)) {

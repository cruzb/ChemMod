...
public class BlockMachineCentrifuge extends BlockMachineBase {

    public BlockMachineCentrifuge(String name) {
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if(!world.isRemote)
            player.openGui(Main.instance, ModGUIs.GUI_CENTRIFUGE, world, pos.getX(), pos.getY(), pos.getZ());
        return true;
    }
    ...
    public static void setState(boolean active, World world, BlockPos pos) {
        ...
        world.setBlockState(pos, ModBlocks.centrifuge.getDefaultState()
                .withProperty(FACING, state.getValue(FACING))

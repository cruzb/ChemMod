...
public class GuiMachineBoiler extends GuiContainer {
    ...
    public GuiMachineBoiler(InventoryPlayer player, TileEntityMachineBoiler tileEntity) {
        super(new ContainerMachineBoiler(player, tileEntity));
        this.player = player;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if(TileEntityMachineBoiler.isActive(tileEntity)) {

...
public class ContainerMachineCentrifuge extends Container {
    private final TileEntityMachineCentrifuge tileEntity;
    private int cookTime, totalCooktime, burnTime, currentBurntime;

    public ContainerMachineCentrifuge(InventoryPlayer player, TileEntityMachineCentrifuge tileEntity) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int index) {
        ...
        if(slot != null && slot.getHasStack()) {
            ...
            if(index == 3) {
                ...
                if(!RecipesMachineCentrifuge.getInstance().getResult(stack1, slot1.getStack()).isEmpty()) {
                    if(!this.mergeItemStack(stack1, 0, 2, false))
                        return ItemStack.EMPTY;
                    else if(TileEntityMachineCentrifuge.isItemFuel(stack1))
